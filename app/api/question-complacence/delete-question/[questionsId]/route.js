...
export async function DELETE(request, { params }) {
    ...
    try {
        ...
        const backendUrl = `${EXTERNAL_API_URL}/question-complacence/delete-question/${questionsId}`;
        ...
        console.error(`Proxy DELETE /question-complacence/${questionsId} Error:`, error);
        if (error.response) {
